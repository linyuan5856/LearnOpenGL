...
bool canIrradiance = true;
bool canSpecular = true;
...
int main()
{
	...
	while (!glfwWindowShouldClose(window))
	{
		...
		pbrShader.setBool("canSpecular", canSpecular);
		pbrShader.setBool("canIrradiance", canIrradiance);

		std::cout << "canSpecular-->   " << canSpecular << endl
			<< "canIrradiance-->    " << canIrradiance << endl;
...
void processInput(GLFWwindow *window)
{
	...
	if (glfwGetKey(window, GLFW_KEY_Q) == GLFW_PRESS)
		canIrradiance = !canIrradiance;
	if (glfwGetKey(window, GLFW_KEY_E) == GLFW_PRESS)
		canSpecular = !canSpecular;
}
